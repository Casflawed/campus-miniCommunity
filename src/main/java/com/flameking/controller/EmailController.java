...
import com.flameking.dto.EmailDto;
import com.flameking.entity.LimitIp;
import com.flameking.entity.ResultBean;
import com.flameking.limiter.RateLimiter;
...
public class EmailController {
    ...
    public ResultBean sendEmail(@Validated @RequestBody EmailDto email, HttpServletRequest request) throws MessagingException {
        ...
        return ResultBean.success("邮件已发送,请在10分钟内完成注册");
    }
